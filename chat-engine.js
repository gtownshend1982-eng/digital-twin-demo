...
(function () {
  ...
  window.twinReply=function(p,raw,state){
    ...
    if(/\bslow\b|boring day|dead day/.test(t))
      return "Slow day huh? How can we change that?";
